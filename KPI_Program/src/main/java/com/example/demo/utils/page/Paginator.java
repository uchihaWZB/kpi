...
/**
 * 分页器实现，为使用方便，从开源的WebX框架（http://www.openwebx.org）中复制至此，保留原作者的所有权利。
 * 原开源代码位置：
 * https://github.com/webx/citrus/blob/master/common/util/src/main/java/com/alibaba/citrus/util/Paginator.java
 *
 * @author Michael Zhou
 *
 * <p>
